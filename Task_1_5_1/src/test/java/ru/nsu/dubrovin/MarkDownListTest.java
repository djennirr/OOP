...
class MarkDownListTest {
    ...
    @Test
    void testEquals() {
        MarkDownList markDownList1 = MarkDownList.builder().addLine("aaa").addLine("bbb").setType(MarkDownList.ListType.NUMERATED).build();
        MarkDownList markDownList2 = MarkDownList.builder().addLine("aaa").addLine("bbb").setType(MarkDownList.ListType.NUMERATED).build();
        MarkDownList markDownList3 = MarkDownList.builder().addLine("aaa").addLine("bbb").setType(MarkDownList.ListType.USUAL).build();
