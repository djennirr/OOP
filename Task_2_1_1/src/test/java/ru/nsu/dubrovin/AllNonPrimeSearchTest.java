...
public class AllNonPrimeSearchTest {
    ...
    boolean speedTest(PrimeSearchable primeSearchable, int[] arr) throws InterruptedException {
        ...
        System.out.println(primeSearchable.getClass().getName() + " finished in " + workTime
            + " millis.");
        return flag;
    }

    @Nested
    @DisplayName("Only prime numbers")
    class OnlyPrimeNumbers {
        @ParameterizedTest()
        ...
        void allPrimesTest3(PrimeSearchable primeSearchable) throws InterruptedException {
            int[] somePrimeNumbers = new int[]{10007, 10009, 10037, 10039, 10061, 10067, 10069,
    ...
    @Nested
    @DisplayName("Not only prime numbers")
    class NotOnlyPrimeNumbers {
        @ParameterizedTest()
        @ArgumentsSource(PrimeSearchableProvider.class)
        ...
        void notAllPrimesTest3(PrimeSearchable primeSearchable) throws InterruptedException {
            int[] somePrimeNumbers = new int[]{10007, 10009, 10037, 10039, 10061, 10067, 10069,
                ...
                10631, 10639, 10651, 10657, 10663, 10667, 10687, 10691, 10709, 10711, 10723, 10729,
                10733, 10739, 10753, 10771, 10781, 10789, 10799, 10831, 10837, 10847, 10853, 10859,
                10861, 10867, 10883, 10889, 10891, 10903, 10909, 10937, 10939, 10939 * 10939};
    ...
    void notAllPrimesSpeedTest(PrimeSearchable primeSearchable) throws InterruptedException {
        int[] somePrimeNumbers = new int[10];
        for (int i = 0; i < 10; i++) {
            somePrimeNumbers[i] = 2147483629;
        }
